...
{
    [ScopedDependency(ServiceType = typeof(INhapKhoVatTuNhomKSNKService))]
    public partial class NhapKhoVatTuNhomKSNKService : MasterFileService<NhapKhoVatTu>, INhapKhoVatTuNhomKSNKService
    {
        ...
        public NhapKhoVatTuNhomKSNKService(IRepository<NhapKhoVatTu> repository
        ...
        public GridDataSource GetDataForGridAsync(QueryInfo queryInfo)
        {
            ...
            var query = new List<NhapKhoKSNKGridVo>().AsQueryable();
        ...
        public async Task<GridDataSource> GetDataForGridChildAsync(QueryInfo queryInfo)
        {
            ...
            var query = _yeuCauNhapKhoVatTuChiTietRepository.TableNoTracking
               ...
               .Select(s => new NhapKhoKSNKChiTietGripVo()
               {
                   Id = s.Id,
        ...
        public async Task<long> GetKhoHanhChinh()
        {
            return (await _khoRepository.TableNoTracking.FirstOrDefaultAsync(p => p.LoaiKho == Core.Domain.Enums.EnumLoaiKhoDuocPham.KhoHanhChinh))?.Id ?? 0;
        }
        ...
        public async Task<List<YeuCauNhapKhoKSNKChiTietGridVo>> YeuCauNhapKhoVatTuChiTiets(long Id, string kyHieuHD, string soChungTu, List<YeuCauNhapKhoKSNKChiTietGridVo> models)
        {
            var yeuCauNhapKhoDuocPhamChiTietGridVos = new List<YeuCauNhapKhoKSNKChiTietGridVo>();
        ...
        public async Task<YeuCauNhapKhoKSNKChiTietGridVo> GetVatTuGrid(YeuCauNhapKhoKSNKChiTietGridVo model)
        {
        ...
        private IQueryable<NhapKhoKSNKGridVo> getDataYeuCauNhapKhoVatTu(bool? duocKeToanDuyet, QueryInfo queryInfo, NhapKhoKSNKSearch queryObject)
        {
            var result = _yeuCauNhapKhoVatTuRepository.TableNoTracking
                ...
                .Select(s => new NhapKhoKSNKGridVo
                {
                    Id = s.Id,
        ...
        public LookupItemVo KhoKSNK()
        {
            var khoVatTuYte = new LookupItemVo();
            var entityKhoVTYT = _khoRepository.TableNoTracking
                                              .Where(c => c.LoaiVatTu == true && c.LoaiKho == Enums.EnumLoaiKhoDuocPham.KhoKSNK)
                                              .FirstOrDefault();
