    ...
    public partial class YeuCauHoanTraVatTuService
    {
        public async Task<GridDataSource> GetDataForGridAsync(QueryInfo queryInfo, bool exportExcel = false)
        {
            ...
            var query = BaseRepository.TableNoTracking.Where(p => p.Id == 0)
                .Select(s => new DanhSachYeuCauHoanTraVatTuGridVo())
                .AsQueryable();
        ...
        private IQueryable<DanhSachYeuCauHoanTraVatTuGridVo> GetDataYeuCauTraVatTu(bool? duocDuyet, QueryInfo queryInfo, NhapKhoVatTuSearch queryObject)
        {
            ...
            .Select(o => new DanhSachYeuCauHoanTraVatTuGridVo
            {
                Id = o.Id,
            ...
            if (queryObject != null)
            {
                if (queryObject.RangeNhap != null && queryObject.RangeNhap.startDate != null)
                {
                    ...
                    result = result
                        ...
                        as IOrderedQueryable<DanhSachYeuCauHoanTraVatTuGridVo>;
                }
        ...
        public async Task<GridDataSource> GetDataForGridChildAsync(QueryInfo queryInfo)
        {
            var query = _ycTraVtChiTiet.TableNoTracking
                ...
                .Select(s => new DanhSachYeuCauHoanTraVatTuChiTietGridVo
                {
                    Id = s.Id,
            ...
            var groupQuery = query.GroupBy(x => new { x.VatTuBenhVienId, x.LaVatTuBhyt, x.Ma, x.Vat, x.SoLo, x.HanSuDung, x.DVT })
                .Select(g => new DanhSachYeuCauHoanTraVatTuChiTietGridVo
                {
