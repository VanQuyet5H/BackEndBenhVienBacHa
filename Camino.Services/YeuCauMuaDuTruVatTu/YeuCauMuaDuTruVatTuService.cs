...
{
    [ScopedDependency(ServiceType = typeof(IYeuCauMuaDuTruVatTuService))]

    public partial class YeuCauMuaDuTruVatTuService : MasterFileService<DuTruMuaVatTu>, IYeuCauMuaDuTruVatTuService
    {
        ...
        public YeuCauMuaDuTruVatTuService(
