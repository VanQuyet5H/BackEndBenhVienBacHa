    ...
    public partial class YeuCauMuaDuTruVatTuService
    {
        ...
        public async Task<GridDataSource> GetDuTruMuaVatTuDangChoXuLyTaiKhoaChiTietForGridAsync(QueryInfo queryInfo)
        {
            ...
            var queryable = _duTruMuaVatTuChiTietRepository
                    ...
                    .Select(item => new DuTruMuaVatTuTaiKhoaChiTietVo()
                    {
                        Id = item.Id,
        ...
        public async Task<GridDataSource> GetDataDuTruMuaVatTuTaiKhoaForGridAsync(QueryInfo queryInfo, bool exportExcel = false)
        {
            BuildDefaultSortExpression(queryInfo);
            ...
            var queryObject = new DuTruMuaVatTuTaiKhoaSearch();

            if (!string.IsNullOrEmpty(queryInfo.AdditionalSearchString))
            {
                queryObject = JsonConvert.DeserializeObject<DuTruMuaVatTuTaiKhoaSearch>(queryInfo.AdditionalSearchString);
            }
            ...
            var query = BaseRepository.TableNoTracking.Where(p => p.Id == 0)
                .Select(s => new DuTruMuaVatTuTaiKhoaGridVo())
                .AsQueryable();
        ...
        public async Task<GridDataSource> GetTotalDuTruMuaVatTuTaiKhoaForGridAsync(QueryInfo queryInfo)
        {
            BuildDefaultSortExpression(queryInfo);
            ReplaceDisplayValueSortExpression(queryInfo);
            ...
            if (!string.IsNullOrEmpty(queryInfo.AdditionalSearchString))
            {
                var queryString = JsonConvert.DeserializeObject<DuTruMuaVatTuTaiKhoaGridVo>(queryInfo.AdditionalSearchString);
        ...
        private IQueryable<DuTruMuaVatTuTaiKhoaGridVo> GetDataYeuCauTraVatTu(bool? duocDuyet, QueryInfo queryInfo, DuTruMuaVatTuTaiKhoaSearch queryObject)
        {
            ...
            var data = result.Where(p => p.TruongKhoaDuyet == duocDuyet && p.TruongKhoaDuyet != false
                ...
                .Select(o => new DuTruMuaVatTuTaiKhoaGridVo
                {
                    Id = o.Id,
                    SoPhieu = o.SoPhieu,
        ...
        public async Task<bool> TuChoiDuyetTaiKhoa(ThongTinLyDoHuyDuyetVatTuTaiKhoa thongTinLyDoHuyNhapKhoDuocPham)
        {
        ...
        public async Task<bool> DuyetTaiKhoa(DuyetDuTruMuaVatTuViewModel model)
        {
        ...
        public GetThongTinGoiVatTuTaiKhoa GetThongTinGoiTaiKhoa(long phongBenhVienId)
        {
            ...
            if (khoaPhong != null)
            {
                var thongTinDuTru = new GetThongTinGoiVatTuTaiKhoa
                {
            ...
            return new GetThongTinGoiVatTuTaiKhoa();
        }

        #region Danh sách con dự trù chi tiết       

        public async Task<GridDataSource> GetDuTruMuaVatTuTaiKhoaChiTietForGridAsync(QueryInfo queryInfo)
        {
            BuildDefaultSortExpression(queryInfo);
        ...
        public async Task<GridDataSource> GetTotalDuTruMuaVatTuTaiKhoaChiTietForGridAsync(QueryInfo queryInfo)
        {
            long duTruMuaVatTuId = !string.IsNullOrEmpty(queryInfo.AdditionalSearchString) ? long.Parse(queryInfo.AdditionalSearchString) : 0;
            var queryable = _duTruMuaVatTuChiTietRepository
                    .TableNoTracking.Where(cc => cc.DuTruMuaVatTuId == duTruMuaVatTuId)
        ...
        public ThongTinDuTruMuaVatTu ThongTinDuTruMuaVatTuHopDongThau(DuTruMuaVatTuTaiKhoaChiTietVo thongTinChiTietVatTuTonKho)
        {
        ...
        public GridDataSource GetDanhTruMuaTaiKhoaChiTietForGridAsync(QueryInfo queryInfo)
        {
            ...
            var queryable = _duTruMuaVatTuChiTietRepository
                    ...
                    .Select(item => new ThongTinDuTruMuaVatTuChiTietTaiKhoa
                    {
                        Id = item.Id,
        ...
        public long GoiThongTinTaiKhoa(DuyetDuTruMuaVatTuViewModel model)
        {
        ...
        public string InPhieuDuTruMuaTaiKhoa(PhieuInDuTruMuaVatTuTaiKhoa phieuInDuTruMuaTaiKhoa)
        {
            ...
            //var duTruMuaVatTus = _duTruMuaVatTuTheoKhoaRepository.TableNoTracking
            //    .Where(c => c.Id == phieuInDuTruMuaTaiKhoa.DuTruMuaVatTuTheoKhoaId)
            ...
            //var templatePhieuInTongHopDuTruVatTuTaiKhoa = _templateRepository.TableNoTracking.First(x => x.Name.Equals("PhieuInTongHopDuTruVatTuTaiKhoa"));
            //var stt = 0;
            //var duTruMuaVatTuChiTiets = duTruMuaVatTus.SelectMany(cc => cc.DuTruMuaVatTuTheoKhoaChiTiets).Include(cc => cc.VatTu);
            //foreach (var item in duTruMuaVatTuChiTiets)
            //{
            //    stt++;
            ...
            //                        + "<td style = 'border: 1px solid #020000;text-align: center;'>" + item.VatTu.Ma + "</td>"
            //                        + "<td style = 'border: 1px solid #020000;text-align: center;'>" + item.VatTu.Ten + "</td>"
            //                        + "<td style = 'border: 1px solid #020000;text-align: center;'>" + item.VatTu.DonViTinh + "</td>"
            //                        + "<td style = 'border: 1px solid #020000;text-align: right;'>" + item.SoLuongDuTruTruongKhoaDuyet + "</td>"
            //                        + "<td style = 'border: 1px solid #020000;text-align: left;'>" + duTruMuaVatTus.FirstOrDefault()?.GhiChu
            //                        + "</td></tr>";
            //}
            ...
            //    DuTruMuaVatTuChiTiet = duTruMuaVatTuChiTiet,
            //    KhoaPhong = duTruMuaVatTus.FirstOrDefault()?.KhoaPhong?.Ten,
            //    NhanVienLap = duTruMuaVatTus.FirstOrDefault()?.NhanVienYeuCau.User.HoTen,
            ...
            var kyDuTruId = _duTruMuaVatTuTheoKhoaRepository.TableNoTracking
                                            .Where(p => p.DuTruMuaVatTuKhoDuocId == phieuInDuTruMuaTaiKhoa.DuTruMuaVatTuTheoKhoaId)
            ...
            templatePhieuInTongHopDuTruDuocPhamTaiKhoa = _templateRepository.TableNoTracking.Where(x => x.Name.Equals("PhieuInTongHopDuTruVatTuTaiKhoa")).First();
        ...
        public DuTruMuaVatTuViewModel GetThongTinDuTruVatTuTaiKhoa(long duTruVatTuId)
        {
            var duTruMuaVatTu = BaseRepository.TableNoTracking
                                                 .Where(cc => cc.Id == duTruVatTuId)
                                                  .Select(c => new DuTruMuaVatTuViewModel
                                                  {
        ...
        public DuTruMuaVatTuViewModel GetThongTinDuTruVatTuTaiKhoaDaXuLy(long duTruVatTuId)
        {
            var duTruMuaVatTu = _duTruMuaVatTuTheoKhoaRepository.TableNoTracking
                                                 .Where(cc => cc.Id == duTruVatTuId)
                                                 .Select(s => new DuTruMuaVatTuViewModel
                                                 {
                                                     SoPhieu = s.SoPhieu,
        ...
        public async Task<GridDataSource> GetDataTHDTTaiKhoaDaXuLyForGridAsyncDetail(QueryInfo queryInfo)
        {
            ...
            var query = BaseRepository.TableNoTracking
                        ...
                        .Select(s => new DuTruMuaVatTuTaiKhoaGridVoDetail
                        {
                            Id = s.Id,
                            SoPhieu = s.SoPhieu,
                            TenKho = s.Kho.Ten,
        ...
        public async Task<GridDataSource> GetDuTruMuaVatTuTHDTChiTietForGridAsync(QueryInfo queryInfo)
        {
            //BuildDefaultSortExpression(queryInfo);
            if (string.IsNullOrEmpty(queryInfo.AdditionalSearchString))
            {
        ...
        public async Task<GridDataSource> GetTotalDuTruMuaVatTuTHDTChiTietForGridAsync(QueryInfo queryInfo)
        {
            if (string.IsNullOrEmpty(queryInfo.AdditionalSearchString))
            {
                return null;
        ...
        public async Task<GridDataSource> GetDuTruMuaDuocPhamTaiKhoaChiTietForGridAsyncChild(QueryInfo queryInfo)
        {
            ...
            var query = _duTruMuaVatTuChiTietRepository.TableNoTracking
                ...
                .Select(s => new DuTruMuaVatTuTaiKhoaChiTietVo
                {
                    Id = s.Id,
        ...
        public async Task<GridDataSource> GetDuTruMuaVatTuChiTietForGridAsyncChild(QueryInfo queryInfo)
        {
            if (string.IsNullOrEmpty(queryInfo.AdditionalSearchString))
            {
                return null;
        ...
        public async Task<GridDataSource> GetTotalDuTruMuaVatTuChiTietForGridAsyncChild(QueryInfo queryInfo)
        {
            if (string.IsNullOrEmpty(queryInfo.AdditionalSearchString))
            {
                return null;
        ...
        public async Task<GridDataSource> GetDataDuTruMuaVatTuTuChoiTaiKhoaForGridAsync(QueryInfo queryInfo)
        {
            BuildDefaultSortExpression(queryInfo);
            BuildDefaultSortExpression(queryInfo);
            var query = BaseRepository.TableNoTracking;
        ...
        public async Task<GridDataSource> GetTotalDuTruMuaVatTuTuChoiTaiKhoaForGridAsync(QueryInfo queryInfo)
        {
            BuildDefaultSortExpression(queryInfo);
            BuildDefaultSortExpression(queryInfo);
            var query = BaseRepository.TableNoTracking;
