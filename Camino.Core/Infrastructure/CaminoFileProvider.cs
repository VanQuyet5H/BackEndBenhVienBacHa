...
namespace Camino.Core.Infrastructure
{
    ...
    /// </summary>
    [ScopedDependency(ServiceType = typeof(ICaminoFileProvider))]
    public class CaminoFileProvider : PhysicalFileProvider, ICaminoFileProvider
    {
        public CaminoFileProvider(IHostingEnvironment hostingEnvironment)
