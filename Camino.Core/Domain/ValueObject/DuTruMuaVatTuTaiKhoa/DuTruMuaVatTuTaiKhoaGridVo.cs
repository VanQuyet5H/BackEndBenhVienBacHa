...
namespace Camino.Core.Domain.ValueObject.DuTruMuaVatTuTaiKhoa
{
    public class DuTruMuaVatTuTaiKhoaGridVo : GridItem
    {
    ...
    public class DuTruMuaVatTuTaiKhoaSearch
    {
    ...
    public class DuTruMuaVatTuViewModel
    {
        public string SoPhieu { get; set; }
    ...
    public class DuTruMuaVatTuTaiKhoaChiTietVo : GridItem
    {
        public DuTruMuaVatTuTaiKhoaChiTietVo()
        {
    ...
    public class ThongTinDuTruMuaVatTuChiTietTaiKhoa : GridItem
    {
        public string TenKho { get; set; }
        public DateTime TuNgay { get; set; }
        public DateTime DenNgay { get; set; }
    ...
    public class DuyetDuTruMuaVatTuViewModel
    {
        public long DuTruMuaVatTuId { get; set; }
        ...
        public string GhiChu { get; set; }
        public List<DuTruMuaVatTuTaiKhoaChiTietVo> DuTruMuaVatTuTaiKhoaChiTietVos { get; set; }
    }
    ...
    public class ThongTinLyDoHuyDuyetVatTuTaiKhoa
    {
        public long Id { get; set; }
        public string LyDoHuy { get; set; }
    }

    public class GetThongTinGoiVatTuTaiKhoa
    {
        public long KhoaPhongId { get; set; }
    ...
    public class DuTruMuaVatTuTaiKhoaGridVoDetail : GridItem
    {
        public string SoPhieu { get; set; }
        public string TenKho { get; set; }
