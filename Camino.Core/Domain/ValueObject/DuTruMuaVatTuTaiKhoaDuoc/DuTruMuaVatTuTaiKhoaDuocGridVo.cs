...
namespace Camino.Core.Domain.ValueObject.DuTruMuaVatTuTaiKhoaDuoc
{
        ...
        public class DuTruMuaVatTuTaiKhoaDuocGridVo : GridItem
        {
        ...
        public class DuTruMuaVatTuTaiKhoaDuocDaXuLy : GridItem
        {
            public string SoPhieu { get; set; }
        ...
        public class DuTruMuaVatTuTaiKhoaDuocSearch
        {
        ...
        public class DuTruMuaVatTuTaiKhoaDuocTuChoiSearch
        {
            public string SearchString { get; set; }
            public RangeDate RangeNhap { get; set; }
        }
        public class DuTruMuaVatTuTaiKhoaDuocSearchDaXuLy
        {
        ...
        public class DuTruMuaVatTuTaiKhoaDuocChildGridVo : GridItem
        {
            public DuTruMuaVatTuTaiKhoaDuocChildGridVo()
            {
                TongTonList = new List<KhoTongTon>();
                HopDongChuahapList = new List<HopDongChuaNhap>();
            }
            public long KhoId { get; set; }
            ...
            public List<KhoTongTon> TongTonList { get; set; }
            public List<HopDongChuaNhap> HopDongChuahapList { get; set; }
        }
        public class DuTruMuaVatTuTaiKhoaDuocChildChildGridVo : GridItem
        {
        ...
        public class DuTruMuaVatTuTaiKhoaDuocChildNhaThuocBenhVien : GridItem
        {
            public DuTruMuaVatTuTaiKhoaDuocChildNhaThuocBenhVien()
            {
                TongTonList = new List<KhoTongTon>();
                HopDongChuahapList = new List<HopDongChuaNhap>();
            }
        ...
        public class KhoTongTon
        {
            public string TenKhoTong { get; set; }
            public double TongTon { get; set; }
        }
        public class HopDongChuaNhap
        {
            public string TenHopDong { get; set; }
            public double TongTon { get; set; }
        }
        #region GET LIST DATA
        public class DuTruMuaVatTuChiTietViewGridVo : GridItem
        {
            ...
            public string GhiChu { get; set; }
            public List<ThongTinChiTietTongHopDuTruTuaTaiKhoaDuocList> thongTinChiTietTongHopDuTruTuaTaiKhoaDuocList { get; set; }
        }
        public class ThongTinChiTietTongHopDuTruTuaTaiKhoaDuocList : GridItem
        {
            public ThongTinChiTietTongHopDuTruTuaTaiKhoaDuocList()
            {
                TongTonList = new List<KhoTongTon>();
                HopDongChuahapList = new List<HopDongChuaNhap>();
            }
            ...
            public List<KhoTongTon> TongTonList { get; set; }
            public List<HopDongChuaNhap> HopDongChuahapList { get; set; }
            public List<ThongTinChiTietTongHopDuTruTuaTaiKhoaDuocListChild1> thongTinChiTietTongHopDuTruTuaTaiKhoaDuocListChild { get; set; }
        }
        public class ThongTinChiTietTongHopDuTruTuaTaiKhoaDuocListChild1 : GridItem
        {
            public string Nhom { get; set; }
            public string Kho { get; set; }
            public DateTime TuNgay { get; set; }
        ...
        public class DuTruMuaVatTuTuChoiGridVo : GridItem
        {
            public string SoPhieu { get; set; }
        ...
        public class DuTruMuaVatTuChiTietGoiViewGridVo : GridItem
        {
            //public string TenLoaiDuTru { get; set; }
            //public long LoaiDuTruId { get; set; }
            //public string SoPhieu { get; set; }
            ...
            public string LyDoTuChoi { get; set; }
            public List<ThongTinChiTietTongHopDuTruTuaTaiKhoaDuocGoiList1> thongTinChiTietTongHopDuTruTuaTaiKhoaDuocGoiList { get; set; }
        }
        public class ThongTinChiTietTongHopDuTruTuaTaiKhoaDuocGoiList1 : GridItem
        {
            public ThongTinChiTietTongHopDuTruTuaTaiKhoaDuocGoiList1()
            {
                thongTinChiTietTongHopDuTruTuaTaiKhoaDuocListChild = new List<ThongTinChiTietTongHopDuTruTuaTaiKhoaDuocListGoiChild1>();
            }
            public long DuTruMuaVatTuKhoDuocId { get; set; }
            ...
            public List<ThongTinChiTietTongHopDuTruTuaTaiKhoaDuocListGoiChild1> thongTinChiTietTongHopDuTruTuaTaiKhoaDuocListChild { get; set; }
        }
        public class ThongTinChiTietTongHopDuTruTuaTaiKhoaDuocListGoiChild1 : GridItem
        {
            public long DuTruMuaVatTuTheoKhoaId { get; set; }
            public long DuTruMuaVatTuTheoKhoaChiTietId { get; set; }
            public long DuTruMuaVatTuId { get; set; }
        ...
        public class DuTruMuaVatTuKhoaDuocChild : GridItem
        {
            public string SoPhieu { get; set; }
    ...
    #endregion
    public class PhieuMuaDuTruVatTuChiTietData : GridItem
    {
    ...
    public class PhieuInDuTruMuaVatTuTaiKhoa
    {
