...
{
    public class NhapKhoVatTuExportExcel
    {
        public NhapKhoVatTuExportExcel()
        {
            NhapKhoVatTuExportExcelChild = new List<NhapKhoVatTuExportExcelChild>();
        }

        public long Id { get; set; }
        public List<NhapKhoVatTuExportExcelChild> NhapKhoVatTuExportExcelChild { get; set; }
    ...
    public class NhapKhoVatTuExportExcelChild
    {
