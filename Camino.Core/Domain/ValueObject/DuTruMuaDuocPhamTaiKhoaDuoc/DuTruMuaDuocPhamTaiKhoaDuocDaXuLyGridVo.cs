...
{
    public class DuTruMuaDuocPhamTaiKhoaDuocDaXuLyGridVo : GridItem
    {
    ...
    public class DuTruMuaDuocPhamTaiKhoaDuocDaXuLyChildGridVo : GridItem
    {
    ...
    public class DuTruMuaDuocPhamTaiKhoaDuocDaXuLyChildChildGridVo : GridItem
    {
