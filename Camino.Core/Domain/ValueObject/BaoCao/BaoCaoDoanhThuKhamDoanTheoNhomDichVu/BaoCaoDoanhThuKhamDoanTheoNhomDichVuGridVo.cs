...
{
    public class BaoCaoDoanhThuKhamDoanTheoNhomDichVuQueryInfo : QueryInfo
    {
    ...
    public class BaoCaoDoanhThuKhamDoanTheoNhomDichVuDataVo
    {        
        ...
        //public List<BaoCaoDoanhThuKhamDoanTheoNhomDichVuDataXetNghiemVo> BaoCaoDoanhThuKhamDoanTheoNhomDichVuDataXetNghiemVos { get; set; }
    }
    public class BaoCaoDoanhThuKhamDoanTheoNhomDichVuDataXetNghiemVo
    {
        public long Id { get; set; }
        public DateTime? ThoiDiemNhanMau { get; set; }
    }
    public class BaoCaoDoanhThuKhamDoanTheoNhomDichVuYCTNDataVo
    {
        public long YeucauTiepNhanId { get; set; }
        public long HopDongId { get; set; }
        public long CongTyId { get; set; }
    ...
    public class BaoCaoDoanhThuKhamDoanTheoNhomDichVuGridVo : GridItem
    {
    ...
    public class TotalTienDichVuKhamDoanGridVo : GridItem
    {
        public string TenCongTy { get; set; }
        #region DOANH THU DỊCH VỤ TRONG GÓI
        //Nhóm Dv khám bệnh
