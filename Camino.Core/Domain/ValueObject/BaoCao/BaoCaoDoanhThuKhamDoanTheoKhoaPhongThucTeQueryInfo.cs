...
{
    public class BaoCaoDoanhThuKhamDoanTheoKhoaPhongThucTeQueryInfo : QueryInfo
    {
    ...
    public class BaoCaoDoanhThuKhamDoanTheoKhoaPhongThucTeGridVo : GridItem
    {
        public BaoCaoDoanhThuKhamDoanTheoKhoaPhongThucTeGridVo()
        {
            DoanhThuTheoDichVus = new List<DoanhThuTheoDichVuThucTeVo>();
        }
        ...
        public List<DoanhThuTheoDichVuThucTeVo> DoanhThuTheoDichVus { get; set; }

        public List<DoanhThuTheoKhoaThucTeVo> DoanhThuTheoKhoas
            => DoanhThuTheoDichVus.GroupBy(x => x.KhoaId).Select(item => new DoanhThuTheoKhoaThucTeVo()
            {
                KhoaId = item.Key,
    ...
    public class DoanhThuTheoKhoaThucTeVo
    {
    ...
    public class DoanhThuTheoDichVuThucTeVo
    {
