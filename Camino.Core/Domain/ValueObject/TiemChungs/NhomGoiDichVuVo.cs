...
{
    public class TiemChungNhomGoiDichVuThuongDungGridVo : GridItem
    {
        public string TenNhom { get; set; }
        public string MoTa { get; set; }
    }

    public class TiemChungChiTietNhomGoiDichVuThuongDungGridVo : GridItem
    {
    ...
    public class TiemChungChiTietNhomGoiDichVuThuongDungDangChonVo
    {
        public Enums.EnumNhomGoiDichVu NhomDichVu { get; set; }
    ...
    public class TiemChungYeuCauThemGoiDichVuThuongDungVo
    {
        public TiemChungYeuCauThemGoiDichVuThuongDungVo()
        {
            GoiDichVuIds = new List<long>();
            DichVuKhongThems = new List<TiemChungChiDinhGoiDichVuThuongDungDichVuLoiVo>();
        ...
        public List<TiemChungChiDinhGoiDichVuThuongDungDichVuLoiVo> DichVuKhongThems { get; set; }
    ...
    public class TiemChungDichVuBenhVienTheoGoiDichVuVo
    {
    ...
    public class TiemChungGoiDichVuTheoBenhNhanGridVo : GridItem
    {
        public string TenGoiDichVu { get; set; }
    ...
    public class TiemChungGridDataSourceChiTietGoiDichVuTheoBenhNhan
    {
        public ICollection<TiemChungChiTietGoiDichVuTheoBenhNhanGridVo> Data { get; set; }

        public int TotalRowCount { get; set; }
    }

    public class TiemChungTemplateStringIdDichVuTrongGoiVo
    {
        public long YeuCauGoiDichVuId { get; set; }
    ...
    public class TiemChungChiTietGoiDichVuTheoBenhNhanGridVo
    {
        ...
        public string Id
        {
            get
            {
                ...
                var newObj = new TiemChungTemplateStringIdDichVuTrongGoiVo()
                {
        ...
        public bool IsActive => SoLuongConLai > 0 && IsNhomTiemChung;
        ...
        //                        && (!IsDieuTriNoiTru || (IsDieuTriNoiTru && NhomGoiDichVu == Enums.EnumNhomGoiDichVu.DichVuKyThuat && LoaiDichVuKyThuat != Enums.LoaiDichVuKyThuat.SuatAn))
        //                        && !IsDichVuGiuong
        //                        && !IsNhomTiemChung;
    }

    public class TiemChungChiDinhGoiDichVuTheoBenhNhanVo
    {
        public TiemChungChiDinhGoiDichVuTheoBenhNhanVo()
        {
            DichVus = new List<TiemChungChiTietGoiDichVuChiDinhTheoBenhNhanVo>();
            DichVuKhongThems = new List<TiemChungChiDinhGoiDichVuTheoBenhNhanDichVuLoiVo>();
            YeuCauDichVuGiuongBenhVienNews = new List<YeuCauDichVuGiuongBenhVien>();
            YeuCauDichVuKyThuatNews = new List<YeuCauDichVuKyThuat>();
            YeuCauKhamBenhNews = new List<Entities.YeuCauKhamBenhs.YeuCauKhamBenh>();
        }
        ...
        public List<TiemChungChiTietGoiDichVuChiDinhTheoBenhNhanVo> DichVus { get; set; }
        public List<TiemChungChiDinhGoiDichVuTheoBenhNhanDichVuLoiVo> DichVuKhongThems { get; set; }
        public List<Entities.YeuCauKhamBenhs.YeuCauKhamBenh> YeuCauKhamBenhNews { get; set; }
        public List<YeuCauDichVuKyThuat> YeuCauDichVuKyThuatNews { get; set; }
        public List<YeuCauDichVuGiuongBenhVien> YeuCauDichVuGiuongBenhVienNews { get; set; }
    }

    public class TiemChungChiTietGoiDichVuChiDinhTheoBenhNhanVo
    {
    ...
    public class TiemChungChiDinhGoiDichVuThuongDungDichVuLoiVo
    {
        public TiemChungChiDinhGoiDichVuThuongDungDichVuLoiVo()
        {
    ...
    public class TiemChungChiDinhGoiDichVuTheoBenhNhanDichVuLoiVo : TiemChungChiDinhGoiDichVuThuongDungDichVuLoiVo
    {
        public long YeuCauGoiDichVuId { get; set; }
        public long ChuongTrinhGoiDichVuId { get; set; }
        public long ChuongTrinhGoiDichVuChiTietId { get; set; }
    ...
    public class TiemChungDichVuChiDinhCoTrongGoiCuaBenhNhanVo
    {
        public TiemChungDichVuChiDinhCoTrongGoiCuaBenhNhanVo()
        {
            DichVuKhamBenhIds = new List<long>();
            DichVuKyThuatIds = new List<long>();
            DichVuChiDinhCoTrongGois = new List<TiemChungChiTietGoiDichVuTheoBenhNhanGridVo>();
        }
        public long BenhNhanId { get; set; }
        public List<long> DichVuKhamBenhIds { get; set; }
        public List<long> DichVuKyThuatIds { get; set; }
        public string Message { get; set; }
        public List<TiemChungChiTietGoiDichVuTheoBenhNhanGridVo> DichVuChiDinhCoTrongGois { get; set; }
    }

    public class TiemChungDichVuDaChonYCTNVo
    {
    ...
    public class TiemChungChiTietSuDungDichVuGiuongTrongGoiTheoBenhNhanVo
    {
        public long YeuCauGoiDichVuId { get; set; }
        public long DichVuBenhVienId { get; set; }
        public long NhomGiaDichVuBenhVienId { get; set; }
