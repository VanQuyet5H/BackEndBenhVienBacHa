...
{
    public class GoiKhamSucKhoeChungDoanVo : GridItem
    {
    ...
    public class GoiKhamSucKhoeDoanChungKetLuanVo : GridItem
    {
    ...
    public class LookupItemDichVuKhamBenhBVHoacDVKTBenhVienChungTemplateVo
    {
    ...
    public class DichVuKhamBenhGiaBenhVienChungVo
    {
    ...
    public class LookupItemHopDingKhamSucKhoeChungTemplateVo
    {
        public long KeyId { get; set; }
        public string DisplayName { get; set; }
    ...
    public class DichVuKhamBenhBvDVKTBvChungVo : GridItem
    {
        public int LoaiKhamBenhHoacKyThuat { get; set; }
    }

    public class MultiselectKhoaPhongChungTemplateVo
    {
        public long KeyId { get; set; }
        public string DisplayName { get; set; }
