...
{
    public class TemplateSmsController : CaminoBaseController
    {
        // GET: /<controller>/
        readonly IMessagingTemplateService _messagingTemplateService;
        
        public TemplateSmsController(IMessagingTemplateService templateService, IJwtFactory iJwtFactory)
        {
        ...
        {
            int type = (int)(Enums.MessagingType.SMS);
