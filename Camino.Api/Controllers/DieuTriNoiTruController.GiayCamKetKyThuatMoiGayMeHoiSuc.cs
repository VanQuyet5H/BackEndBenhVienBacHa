...
namespace Camino.Api.Controllers
{
    ...
    {
        [HttpGet("GetGiayCamKetKyThuatMoiHS")]
        [ClaimRequirement(Enums.SecurityOperation.View, Enums.DocumentType.DanhSachDieuTriNoiTru)]
        public async Task<GiayCamKetSuDungKyThuatMoiHSViewModel> GetGiayCamKetKyThuatMoiHS(long yeuCauTiepNhanId)
        {
            var giayCamKetKyThuatMoiEntity = await _noiTruHoSoKhacService.GetNoiTruHoSoKhac(yeuCauTiepNhanId, Enums.LoaiHoSoDieuTriNoiTru.GiayCamKetKyThuatMoiHS);
            ...
            if (giayCamKetKyThuatMoiEntity != null)
            {
                ...
                var giayCamKet = JsonConvert.DeserializeObject<GiayCamKetSuDungKyThuatMoiHSViewModel>(giayCamKetKyThuatMoiEntity.ThongTinHoSo);
            ...
            var giayCamKetKtMoi = new GiayCamKetSuDungKyThuatMoiHSViewModel();
        ...
        [HttpPost("UpdateGiayCamKetKyThuatMoiHS")]
        [ClaimRequirement(Enums.SecurityOperation.View, Enums.DocumentType.DanhSachDieuTriNoiTru)]
        public async Task<ActionResult> UpdateGiayCamKetKyThuatMoiHS([FromBody] GiayCamKetSuDungKyThuatMoiHSViewModel giayCamKetKyThuatMoiViewModel, long yeuCauTiepNhanId)
        {
            ...
            if (giayCamKetKyThuatMoiViewModel.IdNoiTruHoSo != null)
            {
                ...
                noiTruHoSoKhac.LoaiHoSoDieuTriNoiTru = Enums.LoaiHoSoDieuTriNoiTru.GiayCamKetKyThuatMoiHS;
            ...
            {
                Id = 0,
                LoaiHoSoDieuTriNoiTru = Enums.LoaiHoSoDieuTriNoiTru.GiayCamKetKyThuatMoiHS,
        ...
        [HttpPost("PhieuInGiayCamKetKyThuatMoiHS")]
        public async Task<ActionResult> PhieuInGiayCamKetKyThuatMoiHS(PhieuDieuTriVaServicesHttpParams dieuTriNoiTruVaServicesHttpParams)
        {
            var phieuIns = await _noiTruHoSoKhacService.PhieuInGiayCamKetKyThuatMoiHS(dieuTriNoiTruVaServicesHttpParams);
            return Ok(phieuIns);
        }
    }
}
