    ...
    <tbody>
        <tr>
            <td style="display: flex;justify-content: space-between;"><b>BỆNH VIỆN ĐKQT BẮC HÀ</b> <span
                    style="font-size: 20px;font-weight: bold; text-align:center"> {{MaPhieuMuaDuTruHoaChat}}</span>
            </td>
        </tr>
        <tr>
...
<table style="padding: 5px;width: 100%;margin-top: 48px;margin-bottom: 48px;">
    <tr>
        <th> <span style="font-size: 20px;">PHIẾU TỔNG HỢP DỰ TRÙ THUỐC, VẮC XIN, HÓA CHẤT XÉT NGHIỆM</span><br> </th>
    </tr>
    <tr>
...
<div style="padding-left: 20px;"> </br>
        ...
        <thead>
            <tr>
                ...
                <th rowspan="2"
                    ...
                    MÃ HÀNG</th>
                <th rowspan="2"
                    style="border: 1px solid #020000; border-collapse: collapse;width: 27%;text-align: center;padding: 5px;">
                    TÊN THUỐC, NỒNG ĐỘ HÀM LƯỢNG</th>
                <th rowspan="2"
                    style="border: 1px solid #020000; border-collapse: collapse; width: 5%;text-align: center;padding: 5px;">
                    ĐƠN VỊ</th>
                <th colspan="1"
                    style="border: 1px solid #020000; border-collapse: collapse;width: 15%;text-align: center;padding: 5px;">
                    SỐ LƯỢNG</th>
                <th rowspan="1"
                    style="border: 1px solid #020000; border-collapse: collapse;width: 8%;text-align: center;padding: 5px; border-bottom:opx;">
                    GHI CHÚ</th>
            </tr>
        </thead>
        <tbody> {{DuTruMuaDuocPhamChiTiet}} </tbody>
    </table>
    <table style="width: 100%;">
        <tbody>
            <tr>
    ...
    <table>
        ...
        <tr>
            <td colspan="2" style="font-size: 15px">&nbsp;&nbsp;&nbsp;<i>+ Khoa dược</i></td>
        </tr>
        <tr>
...
where Name=N'PhieuInTongHopDuTruDuocPhamTaiKhoa'
UPDATE CauHinh
