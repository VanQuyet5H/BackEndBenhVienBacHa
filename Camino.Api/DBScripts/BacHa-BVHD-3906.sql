...
VALUES (N'PhieuTheoDoiThucHienXNDuongMauMaoMachTaiGiuongVaTiemInSulinTheoGioDeFault', N'PHIẾU THEO DÕI THỰC HIỆN XÉT NGHIỆM ĐƯỜNG MÁU
        MAO MẠCH TẠI GIƯỜNG VÀ TIÊM INSULIN THEO GIỜ', N'<style>
    table,
    th,
    td {
...
<div style="width: 100%;text-align: center;font-size: 14px;">
    <b>PHIẾU THEO DÕI THỰC HIỆN XÉT NGHIỆM ĐƯỜNG MÁU <br>
        MAO MẠCH TẠI GIƯỜNG VÀ TIÊM INSULIN THEO GIỜ<b>
</div>
<table width="100%">
    <tr>
        <td style="width: 60%;">
    ...
    <thead>
        <tr>
            ...
            <th style="vertical-align: top;width: 20%;border: 1px solid black;text-align: center;">Thực hiện tiêm
                <br>insulin (liều lượng tính theo<br>đơn vị/ml)
            </th>
...
<table width="100%">
    ...
    <tr>
        <td style="text-align:center;" style="font-size: 14px;text-transform: uppercase;"></td>
        <td style="font-size: 14px; text-align:center;text-transform: uppercase;"><b>ĐIỀU DƯỠNG TRƯỞNG</b></td>
    </tr>
    <tr>
        <td style="font-size: 18px;font-style: italic;text-align:center"></td>
        <td style="font-size: 14px; text-align:center;font-style: italic;">(Ký và ghi rõ họ tên)</td>
    </tr>
    <tr>
        <td style="font-size: 14px; text-align:center;"></td>
        <td style="font-size: 14px; text-align:center;"><br><br><br><br><b>{{DieuDuongTruong}}</b></td>
    </tr>
</table>',1,1,N'PHIẾU THEO DÕI THỰC HIỆN XÉT NGHIỆM ĐƯỜNG MÁU
        MAO MẠCH TẠI GIƯỜNG VÀ TIÊM INSULIN THEO GIỜ',1,0,1,1,GETDATE(),GETDATE())

-----------------------------------------------------------------------------------------------------
INSERT INTO template (Name, Title,
Body,TemplateType,Language,Description,Version,IsDisabled,CreatedById,LastUserId,LastTime,CreatedOn)
VALUES (N'PhieuTheoDoiThucHienXNDuongMauMaoMachTaiGiuongVaTiemInSulinTheoGio', N'PHIẾU THEO DÕI THỰC HIỆN XÉT NGHIỆM ĐƯỜNG MÁU
        MAO MẠCH TẠI GIƯỜNG VÀ TIÊM INSULIN THEO GIỜ', N'<style>
    table,
    th,
    td {
