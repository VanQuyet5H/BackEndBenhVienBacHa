...
VALUES (N'BienBanHoiChanChuyenMon', N'Biên bản hội chẩn chuyên môn', N'<style>
    table,
    th,
    td {
...
<div style="width: 100%;">
    <table width="100%" style="margin-bottom:0;">
        <tr>
            ...
            <td style="text-align: center;font-weight: bold;font-size:15px;vertical-align: top;"> <span
                    style="padding-top: 5px;"><b>CỘNG HÒA XÃ HỘI CHỦ NGHĨA VIỆT NAM</b></span> <br> <b><u>Độc lập - Tự
                        do - Hạnh phúc</u></b> </td>
            <td style="text-align:center;float:right;vertical-align: top;font-size: 15px;"> <img
                    style="height:45px;width: 160px;" src="data:image/png;base64,{{BarCodeImgBase64}}"><br>
    ...
    <table width="100%" style="margin-top: 25px;margin-bottom:0;">
        <tr>
            <td style="float: right;font-style: italic;font-size: 15px;">{{NgayThangNamPhieu}}</td>
        </tr>
    </table>
    <table width="100%" style="margin-top: 11px;margin-bottom:0;">
        <tr>
            <td style="float: right;font-style: italic;font-size: 15px;">{{SoVaoVien}}</td>
        </tr>
    </table>
    ...
    <table style="width:100%">
        <tr>
            <td style="width: 60%;font-size:15px;font-family: Times New Roman;"> {{HoTenNguoiBenh}} </td>
            <td style="width: 30%;font-size:15px;font-family: Times New Roman;"> {{NgayThangNamSinh}} </td>
            <td style="width: 10%;font-size:15px;font-family: Times New Roman;"> {{GioiTinh}} </td>
        </tr>
    </table>
    <table style="width:100%">
        <tr>
            <td style="width: 50%;font-size:15px;font-family: Times New Roman;"> {{DaDieuTriTuNgay}} </td>
            <td style="width: 50%;font-size:15px;font-family: Times New Roman;"> {{DaDieuTriDenNgay}} </td>
        </tr>
    </table>
    <table style="width:100%">
        <tr>
            <td style="width: 25%;font-size:15px;font-family: Times New Roman;"> {{Giuong}} </td>
            <td style="width:25%;font-size:15px;font-family: Times New Roman;"> {{Buong}} </td>
            <td style="width: 50%;font-size:15px;font-family: Times New Roman;"> {{Khoa}} </td>
        </tr>
        <tr>
            <td colspan="3" style="width: 100%;font-size:15px;font-family: Times New Roman;"> {{ChanDoan}} </td>
        </tr>
        <tr>
            <td colspan="3" style="width: 100%;font-size:15px;font-family: Times New Roman;">
                <div class="container">
        ...
        <tr>
            <td colspan="3" style="width: 100%;font-size:15px;font-family: Times New Roman;"> {{ChuToa}} </td>
        </tr>
        <tr>
            <td colspan="3" style="width: 100%;font-size:15px;font-family: Times New Roman;"> {{ThuKy}} </td>
        </tr> {{ThanhVien}} {{TomTat}} {{CacXNCoBan}} {{XNKhac}} <tr>
            <td colspan="3" style="width: 100%;font-size:15px;font-family: Times New Roman;"> {{KetLuan}} </td>
        </tr>
        <tr>
            <td colspan="3" style="width: 100%;font-size:15px;font-family: Times New Roman;"> {{DuKienPhauThuat}} </td>
        </tr>
        <tr>
            <td colspan="3" style="width: 100%;font-size:15px;font-family: Times New Roman;"> {{NhomPhauThuat}} </td>
        </tr>
        <tr>
            <td colspan="3" style="width: 100%;font-size:15px;font-family: Times New Roman;"> {{NhomGayMe}} </td>
        </tr>
        <tr>
            <td colspan="3" style="width: 100%;font-size:15px;font-family: Times New Roman;"> {{PhuongPhapGayMe}} </td>
        </tr> {{NgayGioPhauThuat}} <tr>
            <td colspan="3" style="width: 100%;font-size:15px;font-family: Times New Roman;"> {{DuKienKhac}} </td>
        </tr>
    </table>
    <table style="width:100%;margin-top: 20px;">
        <tr>
            <td
                style="font-size:15px;font-family: Times New Roman;text-transform: uppercase;text-align: center;font-weight: bold;">
                Thành viên </td>
            <td
                style="font-size:15px;font-family: Times New Roman;text-transform: uppercase;text-align: center;font-weight: bold;">
                THƯ KÝ </td>
        ...
        <tr>
            <td style="font-size:15px;font-family: Times New Roman;font-style: italic;text-align: center;"> (Ký và ghi
                rõ họ tên) </td>
            <td style="font-size:15px;font-family: Times New Roman;font-style: italic;text-align: center;"> (Ký và ghi
                rõ họ tên) </td>
            <td style="font-size:15px;font-family: Times New Roman;font-style: italic;text-align: center;"> (Ký và ghi
        ...
        <tr>
            <td style="font-size:15px;font-family: Times New Roman;font-weight: bold;text-align: center;"> <br> <br>
                <br> <br> <br> </td>
            <td style="font-size:15px;font-family: Times New Roman;font-weight: bold;text-align: center;"> <br> <br>
                <br> <br> <br> </td>
            <td style="font-size:15px;font-family: Times New Roman;font-weight: bold;text-align: center;"> <br> <br>
        ...
        <tr>
            <td style="font-size:15px;font-family: Times New Roman;font-weight: bold;text-align: center;">
                <div style="word-break: break-work;font-size: 15px;">{{ChuKyThanhVien}}</div>
            </td>
            <td style="font-size:15px;font-family: Times New Roman;font-weight: bold;text-align: center;">
...
</div>',1,1,N'Biên bản hội chẩn chuyên môn',1,0,1,1,GETDATE(),GETDATE())

select * from Template where Name='BienBanHoiChanChuyenMon'
...
<div style="width: 100%;">
    <div style="float:left;width: 100%;">
        <div style="vertical-align: top;font-size: 15px;width: 30%;float: left;">BỆNH VIỆN ĐKQT BẮC HÀ <br> {{KhoaDangIn}}</div>
        <div style="text-align: center;font-weight: bold;font-size:15px;vertical-align: top;width: 50%;float: left"><b>CỘNG HÒA XÃ HỘI CHỦ NGHĨA VIỆT NAM</b><br> <b><u>Độc lập - Tự
            do - Hạnh phúc</u></b> </div>
        <div style="text-align:right;;vertical-align: top;font-size: 15px;width: 20%;float: left"><img
            style="height:45px;" src="data:image/png;base64,{{BarCodeImgBase64}}"><br>
        <p style="margin:0;padding:0;text-align: center;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Mã TN {{MaTN}}</p></div>
