                ...
                <tr>
                    <td colspan="2">
                        <div class="container">
                            ...
                            <div class="value remove-border-bottom" style="width:40%">{{Tuoi}}</div>
                            <div class="label">sinh ngày</div>
                            <div class="value text-center remove-border-bottom" style="width:15%">{{NgaySinh}}</div>
                            <div class="label">tháng</div>
                            <div class="value text-center remove-border-bottom" style="width:15%">{{ThangSinh}}</div>
                            <div class="label">năm</div>
                            <div class="value text-center remove-border-bottom" style="width:15%">{{NamSinh}}</div>
                        </div>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td>
                        <div class="container-flex">
                            ...
                            <div class="value text-center remove-border-bottom" style="width:30%">{{CanNang}}</div>
                            <div>g</div>
                        </div>
                    </td>
                    <td>
                        <div class="container-flex">
                            ...
                            <div class="value text-center remove-border-bottom" style="width:30%">{{ThanNhiet}}</div>
                            <div>&deg;C</div>
                        </div>
                    </td>
                </tr>
            ...
            <tr>
                <td colspan="2">
                    <div class="container">
                        ...
                        <div class="value text-center remove-border-bottom" style="width:10%">{{GioSinh}}</div>
                        <div class="label"> giờ </div>
                        <div class="value text-center remove-border-bottom" style="width:10%">{{PhutSinh}}</div>
                        <div class="label"> ngày </div>
                        <div class="value text-center remove-border-bottom" style="width:10%">{{NgaySinh}}</div>
                        <div class="label"> tháng </div>
                        <div class="value text-center remove-border-bottom" style="width:10%">{{ThangSinh}}</div>
                        <div class="label"> năm </div>
                        <div class="value text-center remove-border-bottom" style="width:20%">{{NamSinh}}</div>
                        <div class="label"> Tuổi thai khi sinh: </div>
                        <div class="value text-center remove-border-bottom" style="width:20%">{{TuoiThaiKhiSinh}}</div>
                    </div>
                </td>
            </tr>
            <tr>
...
Update dbo.CauHinh
Set [Value] = '2.8.6' where [Name] = 'CauHinhHeThong.DatabaseVesion'