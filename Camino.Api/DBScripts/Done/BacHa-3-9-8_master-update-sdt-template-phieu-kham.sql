...
<table style="width:100%">
  ...
  <!--<tr><td style="width:15%">&nbsp;</td><td><div class="container"><div class="label">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</div><div class="value breakword">&nbsp;</div></div></td></tr>-->
  <!-- <tr> -->
  <!-- <td style="width:15%">&nbsp;</td> -->
  <!-- <td> -->
  <!-- <div class="container"> -->
...
<!-- </div> -->'
where name = N'PhieuKhamBenhVaoVienRangHamMat'
Go
UPDATE CauHinh
