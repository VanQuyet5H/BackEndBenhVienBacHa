...
{
    [TransientDependency(ServiceType = typeof(IValidator<NhapKhoVatTuChiTietTonKhoViewModel>))]

    public class NhapKhoVatTuChiTietViewModelValidator : AbstractValidator<NhapKhoVatTuChiTietTonKhoViewModel>
    {
        public NhapKhoVatTuChiTietViewModelValidator(ILocalizationService localizationService, ITonKhoService tonKhoService)
        {
