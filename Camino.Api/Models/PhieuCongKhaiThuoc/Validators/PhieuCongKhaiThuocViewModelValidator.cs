...
{
    [TransientDependency(ServiceType = typeof(IValidator<PhieuCongKhaiThuocViewModel>))]
    public class PhieuCongKhaiThuocViewModelValidator : AbstractValidator<PhieuCongKhaiThuocViewModel>
    {
        public PhieuCongKhaiThuocViewModelValidator(ILocalizationService localizationService, IDieuTriNoiTruService dieuTriNoiTruService)
        {
