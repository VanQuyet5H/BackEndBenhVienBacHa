...
namespace Camino.Api.Models.PhieuCongKhaiThuoc.Validators
{
    [TransientDependency(ServiceType = typeof(IValidator<ValidateTuNgayDenNgayViewModel>))]
    public class ValidateTuNgayDenNgayViewModelValidator : AbstractValidator<ValidateTuNgayDenNgayViewModel>
    {
        public ValidateTuNgayDenNgayViewModelValidator(ILocalizationService localizationService, IDieuTriNoiTruService dieuTriNoiTruService)
        {
