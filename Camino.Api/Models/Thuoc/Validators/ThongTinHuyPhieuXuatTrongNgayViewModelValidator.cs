...
{
    [TransientDependency(ServiceType = typeof(IValidator<ThongTinHuyPhieuXuatTrongNgayViewModel>))]
    public class ThongTinHuyPhieuXuatTrongNgayViewModelValidator : AbstractValidator<ThongTinHuyPhieuXuatTrongNgayViewModel>
    {
        public ThongTinHuyPhieuXuatTrongNgayViewModelValidator(ILocalizationService localizationService)
        {
