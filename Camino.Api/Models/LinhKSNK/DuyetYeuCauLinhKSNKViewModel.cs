...
namespace Camino.Api.Models.LinhKSNK
{
    public class DuyetYeuCauLinhKSNKViewModel : BaseViewModel
    {
        public DuyetYeuCauLinhKSNKViewModel()
        {
    ...
    public class DuyetYeuCauLinhKSNKChiTietViewModel : BaseViewModel
    {
        ...
        #endregion
        public string TenKhoLinh { get; set; }
        public string NhomKSNK => LaVatTuBHYT == true ? "BHYT" : "Không BHYT";
        public bool LoaiDuocPhamHayVatTu { get; set; }
    }

    public class YeuCauKSNKBenhVienViewModel : BaseViewModel
    {
        public long? VatTuBenhVienId { get; set; }
