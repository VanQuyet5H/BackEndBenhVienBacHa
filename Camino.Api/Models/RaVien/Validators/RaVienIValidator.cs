...
{
    [TransientDependency(ServiceType = typeof(IValidator<Camino.Core.Domain.ValueObject.RaVienNoiTru.RaVien>))]
    public class RaVienIValidator : AbstractValidator<Camino.Core.Domain.ValueObject.RaVienNoiTru.RaVien>
    {
        public RaVienIValidator(ILocalizationService localizationService, IDieuTriNoiTruService noiTruService)
        {
