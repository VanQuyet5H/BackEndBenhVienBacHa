...
{
    public class DuTruMuaKSNKChiTietViewModel : BaseViewModel
    {
    ...
    public class KSNKDuTruGridViewModel : BaseViewModel
    {
        public KSNKDuTruGridViewModel()
        {
            YeuCauMuaVatTuChiTietValidators = new List<KSNKDuTruViewModelValidator>();
        }
        ...
        public List<KSNKDuTruViewModelValidator> YeuCauMuaVatTuChiTietValidators { get; set; }
