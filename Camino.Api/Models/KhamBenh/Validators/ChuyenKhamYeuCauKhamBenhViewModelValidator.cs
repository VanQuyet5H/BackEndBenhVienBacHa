...
{
    [TransientDependency(ServiceType = typeof(IValidator<ChuyenKhamYeuCauKhamBenhViewModel>))]
    public class ChuyenKhamYeuCauKhamBenhViewModelValidator : AbstractValidator<ChuyenKhamYeuCauKhamBenhViewModel>
    {
        public ChuyenKhamYeuCauKhamBenhViewModelValidator(ILocalizationService localizationService)
        {
