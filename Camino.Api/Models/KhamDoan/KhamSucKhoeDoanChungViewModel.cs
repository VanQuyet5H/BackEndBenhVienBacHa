...
{
    public class GoiKhamSucKhoeChungViewModel : BaseViewModel
    {
        public GoiKhamSucKhoeChungViewModel()
        {
            DichVuKhamSucKhoeDoans = new List<GoiKhamDichVuKhamSucKhoeDoanChungViewModel>();
            GoiKhamSucKhoeChungDichVuKhamBenhs = new List<GoiKhamDichVuKhamSucKhoeDoanChungViewModel>();
            GoiKhamSucKhoeChungDichVuDichVuKyThuats = new List<GoiKhamDichVuKhamSucKhoeDoanChungViewModel>();
        }    
        ...
        public List<GoiKhamDichVuKhamSucKhoeDoanChungViewModel> DichVuKhamSucKhoeDoans { get; set; }

        public List<GoiKhamDichVuKhamSucKhoeDoanChungViewModel> GoiKhamSucKhoeChungDichVuKhamBenhs { get; set; }
        public List<GoiKhamDichVuKhamSucKhoeDoanChungViewModel> GoiKhamSucKhoeChungDichVuDichVuKyThuats { get; set; }

    }

    public class GoiKhamDichVuKhamSucKhoeDoanChungViewModel : BaseViewModel
    {
        public GoiKhamDichVuKhamSucKhoeDoanChungViewModel()
        {
            GoiKhamSucKhoeChungNoiThucHiens = new List<GoiKhamSucKhoeChungNoiThucHienViewModel>();
            GoiKhamSucKhoeChungNoiThucHienIds = new List<long>();
        ...
        public bool? GoiChung { get; set; }
        public List<long> GoiKhamSucKhoeChungNoiThucHienIds { get; set; }

        public List<GoiKhamSucKhoeChungNoiThucHienViewModel> GoiKhamSucKhoeChungNoiThucHiens { get; set; }
    ...
    public class GoiKhamSucKhoeChungNoiThucHienViewModel : BaseViewModel
    {
