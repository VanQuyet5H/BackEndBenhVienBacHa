...
{
    public class YeuCauNhapKhoKSNKMappingProfile : Profile
    {
        public YeuCauNhapKhoKSNKMappingProfile()
        {
            CreateMap<YeuCauNhapKhoKSNKViewModel, YeuCauNhapKhoVatTu>().IgnoreAllNonExisting()
            ...
            CreateMap<YeuCauNhapKhoVatTu, YeuCauNhapKhoKSNKViewModel>().IgnoreAllNonExisting()
                .ForMember(d => d.NhapKhoVatTuChiTiets, o => o.MapFrom(y => y.YeuCauNhapKhoVatTuChiTiets));

            CreateMap<YeuCauNhapKhoVatTuChiTietViewModel, YeuCauNhapKhoVatTuChiTiet>().IgnoreAllNonExisting();
            CreateMap<YeuCauNhapKhoVatTuChiTiet, YeuCauNhapKhoVatTuChiTietViewModel>().IgnoreAllNonExisting().AfterMap((s, d) =>
            {
            ...
            CreateMap<YeuCauNhapKhoVatTuChiTietViewModel, YeuCauNhapKhoKSNKChiTietGridVo>().IgnoreAllNonExisting();
            CreateMap<YeuCauNhapKhoKSNKChiTietGridVo, YeuCauNhapKhoVatTuChiTietViewModel>().IgnoreAllNonExisting();

        }

        private void AddOrUpdate(YeuCauNhapKhoKSNKViewModel s, YeuCauNhapKhoVatTu d)
        {
        ...
        private void UpdateTuHopDongThau(YeuCauNhapKhoKSNKViewModel s, YeuCauNhapKhoVatTu d)
        {
        ...
        private void UpdateTuNhaCungCap(YeuCauNhapKhoKSNKViewModel s, YeuCauNhapKhoVatTu d)
        {
