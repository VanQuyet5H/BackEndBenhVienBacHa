...
using DuyetYeuCauLinhVatTuViewModel = Camino.Api.Models.LinhVatTu.DuyetYeuCauLinhVatTuViewModel;

namespace Camino.Api.Models.MappingProfile
{
    public class YeuCauLinhVatTuMappingProfile : Profile
    {
        public YeuCauLinhVatTuMappingProfile()
        {
            CreateMap<YeuCauLinhVatTu, DuyetYeuCauLinhVatTuViewModel>().IgnoreAllNonExisting()
            ...
            CreateMap<YeuCauLinhVatTuChiTiet, DuyetYeuCauLinhVatTuChiTietViewModel>().IgnoreAllNonExisting()
                .AfterMap((s, d) =>
                {
            ...
            CreateMap<DuyetYeuCauLinhVatTuChiTietViewModel, YeuCauLinhVatTuChiTiet>().IgnoreAllNonExisting();

            #region Lĩnh thường Vật tư
            CreateMap<YeuCauLinhVatTuChiTiet, LinhThuongVatTuChiTietViewModel>().IgnoreAllNonExisting()
                 .AfterMap((s, d) =>
                 {
            ...
            CreateMap<LinhThuongVatTuChiTietViewModel, YeuCauLinhVatTuChiTiet>().IgnoreAllNonExisting();
            #endregion
            ...
            #region Duyệt
            CreateMap<Core.Domain.Entities.YeuCauLinhVatTus.YeuCauLinhVatTu, DuyetYeuCauLinhVatTuViewModel>().IgnoreAllNonExisting()
                .ForMember(x => x.DuyetYeuCauLinhVatTuChiTiets, o => o.MapFrom(y => y.YeuCauLinhVatTuChiTiets))
                .AfterMap((s, d) =>
                {
            ...
            CreateMap<DuyetYeuCauLinhVatTuViewModel, Core.Domain.Entities.YeuCauLinhVatTus.YeuCauLinhVatTu>().IgnoreAllNonExisting()
            ...
            CreateMap<Core.Domain.Entities.YeuCauLinhVatTus.YeuCauLinhVatTuChiTiet, DuyetYeuCauLinhVatTuChiTietViewModel>().IgnoreAllNonExisting()
                .AfterMap((s, d) =>
                {
                    d.TenVatTu = s.VatTuBenhVien.VatTus.Ten;
                    d.DVT = s.VatTuBenhVien.VatTus.DonViTinh;
            ...
            CreateMap<DuyetYeuCauLinhVatTuChiTietViewModel, Core.Domain.Entities.YeuCauLinhVatTus.YeuCauLinhVatTuChiTiet>().IgnoreAllNonExisting();

            #endregion
            #region Không duyệt
            CreateMap<KhongDuyetYeuCauLinhVatTuViewModel, Core.Domain.Entities.YeuCauLinhVatTus.YeuCauLinhVatTu>().IgnoreAllNonExisting()
                .ForMember(x => x.YeuCauLinhVatTuChiTiets, o => o.Ignore())
                .AfterMap((s, d) =>
                {
                    if (d.LoaiPhieuLinh == Enums.EnumLoaiPhieuLinh.LinhDuTru)
        ...
        private void AddOrUpdateDuyetYeuCauLinhThuong(KhongDuyetYeuCauLinhVatTuViewModel viewModel, Core.Domain.Entities.YeuCauLinhVatTus.YeuCauLinhVatTu model)
        {
        ...
        private void AddOrUpdateDuyetYeuCauLinhThuongChiTiet(DuyetYeuCauLinhVatTuViewModel viewModel, Core.Domain.Entities.YeuCauLinhVatTus.YeuCauLinhVatTu model)
        {
            foreach (var item in viewModel.DuyetYeuCauLinhVatTuChiTiets)
            {
                if (item.Id == 0)
