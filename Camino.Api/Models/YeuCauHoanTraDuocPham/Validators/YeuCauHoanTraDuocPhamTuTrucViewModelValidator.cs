...
{
    [TransientDependency(ServiceType = typeof(IValidator<YeuCauHoanTraDuocPhamTuTrucViewModel>))]
    public class YeuCauHoanTraDuocPhamTuTrucViewModelValidator : AbstractValidator<YeuCauHoanTraDuocPhamTuTrucViewModel>
    {
        public YeuCauHoanTraDuocPhamTuTrucViewModelValidator(ILocalizationService localizationService, IValidator<YeuCauTraDuocPhamTuTrucChiTietVo> chiTietValidator)
        {
            ...
            RuleForEach(x => x.YeuCauHoanTraDuocPhamChiTiets).SetValidator(chiTietValidator);
        }
    }
}
