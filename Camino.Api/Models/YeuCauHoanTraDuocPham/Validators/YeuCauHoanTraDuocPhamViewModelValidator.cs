...
{
    [TransientDependency(ServiceType = typeof(IValidator<YeuCauHoanTraDuocPhamViewModel>))]
    public class YeuCauHoanTraDuocPhamViewModelValidator : AbstractValidator<YeuCauHoanTraDuocPhamViewModel>
    {
        public YeuCauHoanTraDuocPhamViewModelValidator(ILocalizationService localizationService)
        {
