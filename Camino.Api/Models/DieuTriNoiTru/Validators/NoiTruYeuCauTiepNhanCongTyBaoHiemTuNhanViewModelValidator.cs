...
{
    [TransientDependency(ServiceType = typeof(IValidator<NoiTruYeuCauTiepNhanCongTyBaoHiemTuNhanViewModel>))]
    public class NoiTruYeuCauTiepNhanCongTyBaoHiemTuNhanViewModelValidator : AbstractValidator<NoiTruYeuCauTiepNhanCongTyBaoHiemTuNhanViewModel>
    {
        public NoiTruYeuCauTiepNhanCongTyBaoHiemTuNhanViewModelValidator(ILocalizationService localizationService)
        {
