...
{
    public class HoSoKhacPhieuTheoDoiChucNangSongViewModel : BaseViewModel
    {
        public HoSoKhacPhieuTheoDoiChucNangSongViewModel()
        {
            FilesChuKy = new List<FileChuKyPhieuTheoDoiChucNangSongViewModel>();
        }
        ...
        public List<FileChuKyPhieuTheoDoiChucNangSongViewModel> FilesChuKy { get; set; }
    }

    public class FileChuKyPhieuTheoDoiChucNangSongViewModel : BaseViewModel
    {
