...
{
    [TransientDependency(ServiceType = typeof(IValidator<DichVuKyThuatThongTinGiaViewModel>))]

    public class DichVuKyThuatThongTinGiaViewModelValidator : AbstractValidator<DichVuKyThuatThongTinGiaViewModel>
    {
        public DichVuKyThuatThongTinGiaViewModelValidator(ILocalizationService localizationService)
        {
            RuleFor(x => x.Gia)
